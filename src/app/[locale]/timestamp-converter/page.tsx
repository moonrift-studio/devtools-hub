...
export async function generateMetadata({
  ...
  return generateToolMetadata(locale, "timestampConverter", "timestamp-converter");
}
...
export default async function Page({
  ...
  const { locale } = await params;
  return (
    <ToolPage locale={locale} toolKey="timestampConverter" toolPath="timestamp-converter">
      <Client />
    </ToolPage>
  );
}
