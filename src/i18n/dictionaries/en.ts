const en = {
  ...
  tools: {
    ...
    keywordCounter: {
      ...
      description: "Count specific keyword occurrences in text",
      metaTitle: "Keyword Counter — Count Keyword Occurrences in Text Online",
      metaDescription: "Free online keyword counter. Enter keywords and count their occurrences in any text. Case-sensitive option available. Ideal for SEO, editing, and content analysis.",
      capsule: "Enter your text and specify keywords (one per line) to count their occurrences. Supports case-sensitive and case-insensitive matching. Works with any language including CJK characters.",
      faq: [
        {
          q: "How does this keyword counter work?",
          a: "Enter or paste your source text, then list the keywords you want to search for (one per line). The tool counts how many times each keyword appears in the text using substring matching.",
        },
        {
          q: "Does this tool support Japanese and other CJK languages?",
          a: "Yes. Since you specify the exact keywords to search for, this tool works with any language. It performs substring matching, which is ideal for CJK text where words are not separated by spaces.",
        },
        {
          q: "What is the difference between case-sensitive and case-insensitive search?",
          a: "Case-insensitive search (default) treats uppercase and lowercase letters as the same — 'Hello' and 'hello' are counted as the same keyword. Case-sensitive search counts them separately.",
        },
      ],
    },
    pdfLineBreakRemover: {
