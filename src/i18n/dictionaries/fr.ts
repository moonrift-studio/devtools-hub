...
const fr: Dictionary = {
  ...
  tools: {
    ...
    keywordCounter: {
      name: "Compteur de mots-cl\u00E9s",
      title: "Compteur de mots-cl\u00E9s",
      description: "Compter les occurrences de mots-cl\u00E9s dans un texte",
      metaTitle: "Compteur de mots-cl\u00E9s \u2014 Compter les occurrences de mots-cl\u00E9s en ligne",
      metaDescription: "Compteur de mots-cl\u00E9s gratuit en ligne. Entrez des mots-cl\u00E9s et comptez leurs occurrences dans n'importe quel texte. Option de sensibilit\u00E9 \u00E0 la casse. Id\u00E9al pour le SEO, la r\u00E9daction et l'analyse de contenu.",
      capsule: "Entrez votre texte et sp\u00E9cifiez les mots-cl\u00E9s (un par ligne) pour compter leurs occurrences. Prend en charge la recherche sensible et insensible \u00E0 la casse. Fonctionne avec toutes les langues, y compris le CJK.",
      faq: [
        {
          q: "Comment fonctionne ce compteur de mots-cl\u00E9s ?",
          a: "Entrez ou collez votre texte source, puis listez les mots-cl\u00E9s \u00E0 rechercher (un par ligne). L'outil compte combien de fois chaque mot-cl\u00E9 appara\u00EEt dans le texte par correspondance de sous-cha\u00EEne.",
        },
        {
          q: "Cet outil prend-il en charge le japonais et les autres langues CJK ?",
          a: "Oui. Puisque vous sp\u00E9cifiez les mots-cl\u00E9s exacts \u00E0 rechercher, cet outil fonctionne avec n'importe quelle langue. Il utilise la correspondance de sous-cha\u00EEne, id\u00E9ale pour les textes CJK o\u00F9 les mots ne sont pas s\u00E9par\u00E9s par des espaces.",
        },
        {
          q: "Quelle est la diff\u00E9rence entre la recherche sensible et insensible \u00E0 la casse ?",
          a: "La recherche insensible \u00E0 la casse (par d\u00E9faut) traite les majuscules et minuscules de la m\u00EAme mani\u00E8re \u2014 \u00AB Hello \u00BB et \u00AB hello \u00BB sont compt\u00E9s comme le m\u00EAme mot-cl\u00E9. La recherche sensible les compte s\u00E9par\u00E9ment.",
        },
      ],
    },
    pdfLineBreakRemover: {
